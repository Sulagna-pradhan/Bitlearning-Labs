      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-16 sm:mt-0 mb-12 sm:mb-16 md:mb-20">
          <div className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-[#b5ccbf]/20 to-[#67908c]/20 dark:from-[#b5ccbf]/20 dark:to-[#67908c]/20 rounded-full text-[#67908c] dark:text-[#b5ccbf] mb-4 sm:mb-6 border border-[#b5ccbf]/30">
            <Briefcase className="w-[16px] h-[16px] sm:w-[18px] sm:h-[18px]" />
          ...
          <p className="text-[#67908c] dark:text-[#b5ccbf] max-w-2xl sm:max-w-3xl mx-auto text-base sm:text-lg leading-relaxed px-4">
            Our seamless blend of authentic Indian flavors and global cuisine
            ensures your corporate events are productive, delicious, and
            memorable. From power breakfasts to networking dinners, we deliver
            excellence.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center mb-12 sm:mb-16 md:mb-20">
          ...
          <div className="px-4 sm:px-0">
            ...
            <p className="text-[#67908c] dark:text-[#b5ccbf] mb-6 sm:mb-8 text-base sm:text-lg leading-relaxed">
              Whether it's a high-stakes board meeting or a team-building
              retreat, our menus feature nutritious, flavorful options that fuel
              productivity. Specializing in healthy Indian twists, international
              salads, and quick-service buffets.
            </p>

            <p className="text-[#67908c] dark:text-[#b5ccbf] mb-8 sm:mb-10 leading-relaxed text-base sm:text-lg">
              Our team collaborates with you to align menus with your event
              goals, dietary needs, and branding, ensuring a hassle-free
              experience that impresses.
            </p>

            <ul className="space-y-4 sm:space-y-5 mb-8 sm:mb-12">
              {[
                'Customized Healthy Buffets & Box Lunches',
                'Global & Regional Fusion Menus',
                'Dietary Accommodations (Vegan, Gluten-Free)',
                'Efficient On-Site Service Team',
              ].map((item, idx) => (
                <li
                  key={idx}
          ...
          {[
            {
              ...
              description:
                'Energizing starts with fresh Indian breakfasts, continental options, and healthy smoothies',
              highlight: 'Morning Sessions',
            },
            {
              icon: ChefHat,
              title: 'Lunch Conferences',
              description:
                'Balanced buffets with salads, grilled mains, and regional Indian specialties for midday fuel',
              highlight: 'Midday Events',
            },
            {
              icon: Utensils,
              title: 'Cocktail Receptions',
              description:
                "Sophisticated hors d'oeuvres and finger foods blending Indian street bites with global canapés",
              highlight: 'Evening Mixers',
            },
            {
              icon: Calendar,
              title: 'Team Building Dinners',
              description:
                'Interactive live stations and family-style sharing platters to foster collaboration',
              highlight: 'Group Dinners',
            },
          ].map((service, idx) => (
            <div
              key={idx}
