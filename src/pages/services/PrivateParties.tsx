...
export default function PrivatePartySection() {
        ...
        <div className="text-center mt-16 sm:mt-0 mb-12 sm:mb-16 md:mb-20">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#45422a] dark:text-[#e7e3c2] mb-6 sm:mb-8 leading-tight">
            ...
            <span className="block bg-gradient-to-r from-[#67908c] to-[#40584a] bg-clip-text text-transparent">
              Intimate Indian Feast
            </span>
          </h1>

          <p className="text-[#67908c] dark:text-[#b5ccbf] max-w-2xl sm:max-w-3xl mx-auto text-base sm:text-lg leading-relaxed px-4">
            Elevate your private gatherings with our exquisite Indian flavors,
            blending home-style comfort with gourmet touches. From cozy family
            dinners to lively birthday bashes, we deliver personalized menus
            that turn every occasion into a flavorful memory.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center mb-12 sm:mb-16 md:mb-20">
          ...
          <div className="px-4 sm:px-0">
            ...
            <p className="text-[#67908c] dark:text-[#b5ccbf] mb-6 sm:mb-8 text-base sm:text-lg leading-relaxed">
              Whether it's a milestone birthday, anniversary, or casual house
              party, our menus feature authentic Indian dishes with a modern
              twist.
            </p>

            <p className="text-[#67908c] dark:text-[#b5ccbf] mb-8 sm:mb-10 leading-relaxed text-base sm:text-lg">
              We collaborate closely with you to match dietary needs, portion
              sizes, and ambiance, ensuring seamless service that lets you focus
              on the fun and flavors.
            </p>

            <ul className="space-y-4 sm:space-y-5 mb-8 sm:mb-12">
              {[
                'Customizable Home-Style Thalis',
                'Live Snack Stations',
                'Dietary Accommodations (Vegan, Gluten-Free)',
                'Efficient On-Site Team',
              ].map((item, idx) => (
                <li
                  key={idx}
          ...
          {[
            {
              ...
              description:
                'Fun-filled spreads with kid-friendly chaats, savory snacks, and festive Indian desserts for all ages',
              highlight: 'Milestone Birthdays',
            },
            {
              icon: ChefHat,
              title: 'Anniversary Dinners',
              description:
                'Romantic multi-course meals featuring signature curries, aromatic rice, and decadent mithai',
              highlight: 'Love Renewed',
            },
            {
              icon: Utensils,
              title: 'House Parties',
              description:
                'Casual buffets with finger foods, grilled kebabs, and refreshing beverages for relaxed vibes',
              highlight: 'Casual Gatherings',
            },
            {
              icon: Calendar,
              title: 'Themed Events',
              description:
                'Custom menus inspired by regions or festivals, complete with interactive cooking demos',
              highlight: 'Festive Themes',
            },
          ].map((service, idx) => (
            <div
              key={idx}
